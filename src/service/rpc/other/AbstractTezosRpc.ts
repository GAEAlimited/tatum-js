...
import {
  ...
  GetContractBase, GetContractsBigMapGet, GetContractsEntrypoints, GetInvalidBlocks, GetProtocol, SimulateOperation,
  TezosRpcInterface,
...
export abstract class AbstractTezosRpc implements TezosRpcInterface {
  ...
  getContractsCounter(params: GetContractBase): Promise<any> {
    const { chainId, block} = params
    return this.sendGet({ path: `/chains/${chainId}/blocks/${block}/context/contracts/counter`})
  }
